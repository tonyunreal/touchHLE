...
fn AudioServicesCreateSystemSoundID(_env: &mut Environment, inFileURL: CFURLRef, outSystemSoundID: MutPtr<SystemSoundID>) -> OSStatus {
    // TODO: implement other system sounds
    _env.mem.write(outSystemSoundID, kSystemSoundID_Vibrate);
    0
}
